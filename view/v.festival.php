...
<!-- 1 row avec 4 colonnes dont 2 principales : cardAfficheConcert et cardAfficheComment --> 
  <div class="row">
    ...
    <div class="col-lg-6">
      <h2>Ils ont voté !!! Voici leurs commentaires :</h2>
      <div>
        <p>Tu peux les filtrer ici :</p>
        <form id="comment-filter-form" action="../controller/festival.php" method="post">
          ...
          <input id="filter-value" type="text" name="filter-value" placeholder="" maxlength="25">
        ...
        <?php if (isset($filteredComments)) : ?>
          <?php foreach ($filteredComments as $comment) : ?>
            ...
            <div class="card-body2">
              ...
              <p><strong>Son commentaire : </strong><span style="margin-left: 10px;"></span><?= $comment['content_commentCard'] ?></p>
